...
--CREATE LOGIN hr_user WITH PASSWORD = 'hr_password';
--GO
...
INSERT INTO [dbo].[employees] (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id)
VALUES
